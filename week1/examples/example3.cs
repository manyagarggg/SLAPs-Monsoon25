// Dafny program example3.dfy compiled into C#
...
// Command-line arguments: run example3.dfy
// example3.dfy
  ...
  public partial class __default {
    public static BigInteger fibonacci(BigInteger n)
    {
      ...
      if ((n) <= (BigInteger.One)) {
        ...
        BigInteger _0_a;
        _0_a = BigInteger.Zero;
        BigInteger _1_b;
        _1_b = BigInteger.One;
        BigInteger _2_i;
        _2_i = new BigInteger(2);
        while ((_2_i) <= (n)) {
          BigInteger _3_temp;
          _3_temp = (_0_a) + (_1_b);
          _0_a = _1_b;
    ...
    public static BigInteger Fibonacci(BigInteger n) {
      if ((n) <= (BigInteger.One)) {
        ...
        return (__default.Fibonacci((n) - (BigInteger.One))) + (__default.Fibonacci((n) - (new BigInteger(2))));
      }
    }
  }
